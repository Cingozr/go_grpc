...
var file_laptop_service_proto_rawDesc = []byte{
	...
	0x67, 0x72, 0x70, 0x63, 0x65, 0x78, 0x1a, 0x14, 0x6c, 0x61, 0x70, 0x74, 0x6f, 0x70, 0x5f, 0x6d,
	...
	0x01, 0x28, 0x0b, 0x32, 0x16, 0x2e, 0x63, 0x69, 0x6e, 0x67, 0x6f, 0x7a, 0x72, 0x2e, 0x67, 0x72,
	0x70, 0x63, 0x65, 0x78, 0x2e, 0x4c, 0x61, 0x70, 0x74, 0x6f, 0x70, 0x52, 0x06, 0x6c, 0x61, 0x70,
	...
	0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x02, 0x69, 0x64, 0x32, 0x6a, 0x0a, 0x0d, 0x4c,
	0x61, 0x70, 0x74, 0x6f, 0x70, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x59, 0x0a, 0x0c,
	0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x4c, 0x61, 0x70, 0x74, 0x6f, 0x70, 0x12, 0x23, 0x2e, 0x63,
	0x69, 0x6e, 0x67, 0x6f, 0x7a, 0x72, 0x2e, 0x67, 0x72, 0x70, 0x63, 0x65, 0x78, 0x2e, 0x43, 0x72,
	0x65, 0x61, 0x74, 0x65, 0x4c, 0x61, 0x70, 0x74, 0x6f, 0x70, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73,
	0x74, 0x1a, 0x24, 0x2e, 0x63, 0x69, 0x6e, 0x67, 0x6f, 0x7a, 0x72, 0x2e, 0x67, 0x72, 0x70, 0x63,
	0x65, 0x78, 0x2e, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x4c, 0x61, 0x70, 0x74, 0x6f, 0x70, 0x52,
...
var file_laptop_service_proto_goTypes = []interface{}{
	(*CreateLaptopRequest)(nil),  // 0: cingozr.grpcex.CreateLaptopRequest
	(*CreateLaptopResponse)(nil), // 1: cingozr.grpcex.CreateLaptopResponse
	(*Laptop)(nil),               // 2: cingozr.grpcex.Laptop
}
var file_laptop_service_proto_depIdxs = []int32{
	2, // 0: cingozr.grpcex.CreateLaptopRequest.laptop:type_name -> cingozr.grpcex.Laptop
	0, // 1: cingozr.grpcex.LaptopService.CreateLaptop:input_type -> cingozr.grpcex.CreateLaptopRequest
	1, // 2: cingozr.grpcex.LaptopService.CreateLaptop:output_type -> cingozr.grpcex.CreateLaptopResponse
...
func (c *laptopServiceClient) CreateLaptop(ctx context.Context, in *CreateLaptopRequest, opts ...grpc.CallOption) (*CreateLaptopResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/cingozr.grpcex.LaptopService/CreateLaptop", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _LaptopService_CreateLaptop_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/cingozr.grpcex.LaptopService/CreateLaptop",
	}
...
var _LaptopService_serviceDesc = grpc.ServiceDesc{
	ServiceName: "cingozr.grpcex.LaptopService",
