...
var file_processor_message_proto_rawDesc = []byte{
	...
	0x61, 0x67, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x0e, 0x63, 0x69, 0x6e, 0x67, 0x6f,
	0x7a, 0x72, 0x2e, 0x67, 0x72, 0x70, 0x63, 0x65, 0x78, 0x1a, 0x14, 0x6d, 0x65, 0x6d, 0x6f, 0x72,
	...
	0x79, 0x42, 0x04, 0x5a, 0x02, 0x70, 0x62, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}
...
var file_processor_message_proto_goTypes = []interface{}{
	(*CPU)(nil),    // 0: cingozr.grpcex.CPU
	(*GPU)(nil),    // 1: cingozr.grpcex.GPU
	(*Memory)(nil), // 2: cingozr.grpcex.Memory
}
var file_processor_message_proto_depIdxs = []int32{
	2, // 0: cingozr.grpcex.GPU.memory:type_name -> cingozr.grpcex.Memory
