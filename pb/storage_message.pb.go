...
type Storage struct {
	...
	Driver Storage_Driver `protobuf:"varint,1,opt,name=driver,proto3,enum=cingozr.grpcex.Storage_Driver" json:"driver,omitempty"`
...
var file_storage_message_proto_rawDesc = []byte{
	...
	0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x0e, 0x63, 0x69, 0x6e, 0x67, 0x6f, 0x7a, 0x72,
	0x2e, 0x67, 0x72, 0x70, 0x63, 0x65, 0x78, 0x1a, 0x14, 0x6d, 0x65, 0x6d, 0x6f, 0x72, 0x79, 0x5f,
	...
	0x76, 0x65, 0x72, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x1e, 0x2e, 0x63, 0x69, 0x6e, 0x67,
	0x6f, 0x7a, 0x72, 0x2e, 0x67, 0x72, 0x70, 0x63, 0x65, 0x78, 0x2e, 0x53, 0x74, 0x6f, 0x72, 0x61,
	...
	0x0b, 0x32, 0x16, 0x2e, 0x63, 0x69, 0x6e, 0x67, 0x6f, 0x7a, 0x72, 0x2e, 0x67, 0x72, 0x70, 0x63,
	0x65, 0x78, 0x2e, 0x4d, 0x65, 0x6d, 0x6f, 0x72, 0x79, 0x52, 0x06, 0x6d, 0x65, 0x6d, 0x6f, 0x72,
...
var file_storage_message_proto_goTypes = []interface{}{
	(Storage_Driver)(0), // 0: cingozr.grpcex.Storage.Driver
	(*Storage)(nil),     // 1: cingozr.grpcex.Storage
	(*Memory)(nil),      // 2: cingozr.grpcex.Memory
}
var file_storage_message_proto_depIdxs = []int32{
	0, // 0: cingozr.grpcex.Storage.driver:type_name -> cingozr.grpcex.Storage.Driver
	2, // 1: cingozr.grpcex.Storage.memory:type_name -> cingozr.grpcex.Memory
